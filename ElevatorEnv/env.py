...
class ElevatorEnv(gym.Env):
    ...
    def compute_reward(self, prev_state, action, next_state):
        ...
        reward = (current_arrival)*CURRIVAL_REWARD+(tot_delayed_time)*DELAYED_TIME_REWARD+self.passengerEnv.waiting_passengers(self.tot_floor)*WAITING_TIME_REWARD*DELTA_T#+(non_stop)*NONSTOP_REWARD
